...
public enum ErrorCode {
     ...
     */
    E429_TOO_MANY_REQUESTS(TOO_MANY_REQUESTS, "일시적으로 많은 요청이 들어왔습니다. 잠시후 다시 이용해주세요"),

    /**
     * 500 Internal Server Exception (서버 내부 에러)
     */
    E500_INTERNAL_SERVER(INTERNAL_SERVER_ERROR, "예상치 못한 에러가 발생하였습니다. 잠시 후 다시 시도해주세요!"),
     ...
     */
    E502_BAD_GATEWAY(BAD_GATEWAY, "일시적인 에러가 발생하였습니다. 잠시 후 다시 시도해주세요!"),
